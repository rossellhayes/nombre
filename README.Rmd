...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/nombre)](https://CRAN.R-project.org/package=nombre)
...
The suggested package [**MASS**](https://CRAN.R-project.org/package=MASS) is only required for handling non-integers, a situation that should be rare for most packages considering implementing **nombre**.
